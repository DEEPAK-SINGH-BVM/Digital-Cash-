...
export default function Navbar() {
  ...
  const menuItems3 = [
    ...
    { name: "Mining", href: "", current: false },
  ];
  const menuItems4 = [
    { name: "Bug Bounty Pragram", href: "/BugBounty", current: true },
  ...
  const menuItems5 = [
    ...
    { name: "Hindi", href: "", current: false },
    { name: "Deutsch", href: "", current: false },
    { name: "Ελληνικά", href: "", current: false },
  ];
  return (
    <div>
      <Disclosure
